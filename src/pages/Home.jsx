    ...
    <PageLayout>
      ...
      <section className="pt-12 pb-14 border-b border-slate-200">
        <div className="max-w-2xl">
          <div className="font-mono text-2xs text-brand-600 tracking-widest uppercase mb-4">
            DDR Research · S1 Pendidikan Multimedia · UPI Cibiru
          </div>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 leading-tight mb-4">
